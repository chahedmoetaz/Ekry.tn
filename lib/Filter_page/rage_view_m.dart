...
class RangeSliderViewM extends StatefulWidget {
  const RangeSliderViewM({Key key, this.values, this.onChangeRangeValues})
      : super(key: key);
...
class _RangeSliderViewState extends State<RangeSliderViewM> {
  RangeValues _values;
              ...
              Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '${_values.start.round()} DT',
                      textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.w700,fontSize: 19),
                    ),
                  ),
                  Expanded(
              ...
              Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '${_values.end.round()} DT',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 19),
                      textAlign: TextAlign.center,
                    ),
                  ),
                  Expanded(
                    flex: 3000 - _values.end.round(),
                    child: const SizedBox(),
                  ),
                ],
              ),
