...
class SliderViewM extends StatefulWidget {
  const SliderViewM({Key key, this.onChangedistValue, this.distValue})
      : super(key: key);
...
class _SliderViewState extends State<SliderViewM> {
  double distValue;
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  '${(distValue ).toStringAsFixed(0)} Dt',
                  textAlign: TextAlign.start,
                  style: TextStyle(fontSize: 19),
                ),
              ),
              Expanded(
                flex: 3000 - distValue.round(),
                child: const SizedBox(),
              ),
            ],
          ),
    ...
    canvas.drawPath(
        Path()
          ..addOval(Rect.fromPoints(
              Offset(thumbCenter.dx + 10, thumbCenter.dy + 10),
