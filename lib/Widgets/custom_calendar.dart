...
class CustomCalendarView extends StatefulWidget {
  const CustomCalendarView(
      ...
      this.minimumDate,
      this.maximumDate, ThemeData theme})
      : super(key: key);
            ...
            child: Row(
              children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Icon(
                          tr( "add_type" ) ==
                              "Type"? Icons.keyboard_arrow_left:Icons.keyboard_arrow_right,
                          color: Colors.grey,
                        ),
                      ),
                    ),
                ...
                Expanded(
                  child: Center(
                    child: Text(
                      '${tr(DateFormat('MMMM').format(currentMonthDate))} ${DateFormat('yyyy').format(currentMonthDate)}',
                      style: TextStyle(
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Icon(
                          tr( "add_type" ) ==
                              "Type"? Icons.keyboard_arrow_right:Icons.keyboard_arrow_left,
                          color: Colors.grey,
                        ),
                      ),
                    ),
    ...
    for (int i = 0; i < 7; i++) {
      listUI.add(
        Expanded(
          child: Center(
            child: Text(
              tr(DateFormat('EEE').format(dateList[i])),
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: Theme.of(context).accentColor),
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) ||
                                      ...
                                      : Colors.transparent
                                  : Colors.transparent,
                              borderRadius:tr( "add_type" ) ==
                                  "Type"? BorderRadius.only(
                                ...
                                bottomRight: isEndDateRadius(date)
                                  ...
                                  :
                              BorderRadius.only(
                                bottomRight: isStartDateRadius(date)
                                    ? const Radius.circular(24.0)
                                    : const Radius.circular(0.0),
                                topRight: isStartDateRadius(date)
                                    ? const Radius.circular(24.0)
                                    : const Radius.circular(0.0),
                                topLeft: isEndDateRadius(date)
                                    ? const Radius.circular(24.0)
                                    : const Radius.circular(0.0),
                                bottomLeft: isEndDateRadius(date)
                                    ? const Radius.circular(24.0)
                                    : const Radius.circular(0.0),
                              ),
                            ),
